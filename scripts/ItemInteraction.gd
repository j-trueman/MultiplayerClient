...
const HandManager = preload("res://scripts/HandManager.gd")
const ItemManager = preload("res://scripts/ItemManager.gd")
const Medicine = preload("res://scripts/MedicineManager.gd")
const PermissionManager = preload("res://scripts/PermissionManager.gd")
const RoundManager = preload("res://scripts/RoundManager.gd")
