...
const CameraManager = preload("res://scripts/CameraManager.gd")
const ControllerManager = preload("res://scripts/ControllerManager.gd")
const CursorManager = preload("res://scripts/CursorManager.gd")
const DealerIntelligence = preload("res://scripts/DealerIntelligence.gd")
const DeathManager = preload("res://scripts/DeathManager.gd")
const DefibCutter = preload("res://scripts/DefibCutter.gd")
const GameOverManager = preload("res://scripts/GameOverManager.gd")
const HandcuffManager = preload("res://scripts/HandcuffManager.gd")
const HealthCounter = preload("res://scripts/HealthCounter.gd")
...
const PermissionManager = preload("res://scripts/PermissionManager.gd")
const PlayerData = preload("res://scripts/PlayerData.gd")
const RoundClass = preload("res://scripts/RoundClass.gd")
const SegmentManager = preload("res://scripts/SegmentManager.gd")
const ShellEjectManager = preload("res://scripts/ShellEjectManager.gd")
...
const Statue = preload("res://scripts/StatueManager.gd")
